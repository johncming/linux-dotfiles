...
# go build with debug
alias gob="go build -gcflags \"all=-N -l\""

# list all golang test cases
alias M="go test -list '.+'|rg  '^Test(.+)' -r '\$1 -------> \$0' --color never | sort"

# dlv debug
alias D="dlv debug --backend=rr --headless --api-version=2 --listen=0.0.0.0:8181"
